# MQTT-Based Industrial IoT Gateway Requirements

## Functional Requirements

| ID | Requirement | Verification |
| --- | --- | --- |
| FR-001 | The system shall expose a deterministic host-buildable runtime for MQTT-Based Industrial IoT Gateway. | CMake/CTest smoke run. |
| FR-002 | The system shall model the project focus: Yocto-generated gateway image that polls serial telemetry from Modbus or CAN simulation, parses frames, and publishes cloud updates over MQTT/TLS. | Scenario tests and documentation review. |
