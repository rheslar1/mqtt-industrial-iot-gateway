...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for MQTT-Based Industrial IoT Gateway. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: Yocto-generated gateway image that polls serial telemetry from Modbus or CAN simulation, parses frames, and publishes cloud updates over MQTT/TLS. | Scenario tests and documentation review. |
